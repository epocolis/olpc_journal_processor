...
echo -n "command=\"%{_bindir}/olpc-journal-processor ${SSH_ORIGINAL_COMMAND#* }\",no-port-forwarding,no-X11-forwarding,no-agent-forwarding,no-pty " >> "%{_datadir}/%{name}/.ssh/authorized_keys"
